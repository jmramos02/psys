     ...
     <h3>Pending Overtime Request</h3>
        <?php 
          if(isset($_GET['r'])){
            ...
            <table border='1'>     
              <?php
                $query = "SELECT * from employeemasterfile.otRequest where status='waiting for approval';" or die("Error. " . mysqli_error($link));
                  ...
                  <?php while($rows = mysqli_fetch_array($result)){
                    ...
                    echo 
                      "<tr>
                        ...
                        <td>$rows[1]</td>
                        <td>$rows[2]</td>
                        <td><a href='requestApproval.php?pend=3&e=$e&r=$r'>Full Details</a></td>
                      </tr>";
                    }
                  }
                }
